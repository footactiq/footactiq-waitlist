...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      scrolled ? "bg-[#0A192F]/90 backdrop-blur-xl py-3" : "bg-transparent py-6"
    }`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-lg bg-brand-blue flex items-center justify-center glow-blue transition-all group-hover:scale-110">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <circle cx="9" cy="9" r="7" stroke="white" strokeWidth="1.5"/>
              <path d="M9 4L11 7H7L9 4Z" fill="white"/>
              <path d="M6 7L4 10L7 12L9 7H6Z" fill="white" opacity="0.7"/>
              <path d="M12 7L14 10L11 12L9 7H12Z" fill="white" opacity="0.7"/>
              <path d="M7 12L9 14L11 12H7Z" fill="white" opacity="0.5"/>
            </svg>
          </div>
          <span className="font-bold text-xl text-white uppercase tracking-widest"
