...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center text-center px-6 max-w-4xl mx-auto"
        style={{ zIndex: 2 }}>
        <h1 className="font-black mb-5 leading-[1.05] w-full max-w-4xl text-[28px] sm:text-[34px] lg:text-[45px] tracking-wide"
          style={{ color: "#FFFFFF" }}>
