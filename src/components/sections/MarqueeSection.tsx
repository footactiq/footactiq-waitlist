...
const HIGHLIGHT = ["Or","Football","AI-Powered","Club","Instant","Player","Tactical","Match"];

export default function MarqueeSection() {
  const doubled = [...ITEMS,...ITEMS];
  return (
    <section className="relative py-5 overflow-hidden border-y mb-16  " style={{ background:"#fff", borderColor:"rgba(0,0,0,0.08)" }}>
      <div className="flex">
        <div className="marquee-track">
          {doubled.map((item,i)=>(
            <span key={i} className="flex items-center gap-4 px-6 whitespace-nowrap">
              <span className="font-black text-sm md:text-base uppercase tracking-tight text-black">
